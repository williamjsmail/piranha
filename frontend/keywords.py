...
def save_keyword_ioc_mapping():
    ...
    try:
        ...
        logger.info(f" Successfully saved updated keyword-to-IOM mapping.")
...
def add_keyword_popup(parent, listbox=None):
    ...
    layout.addWidget(QLabel("Enter Indicators of Methodology:"))
...
def edit_keyword_popup(parent, listbox):
    ...
    layout.addWidget(QLabel("Modify IOM List:"))
    ...
    def save_edits():
        ...
        if not new_iocs or not new_tools:
            QMessageBox.critical(parent, "Error", "IOM and Tool fields cannot be empty.")
            return
